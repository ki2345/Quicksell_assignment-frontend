        ...
        <div className="board-container">
            <div className="header">
                <div className="left-header">
                    ...
                    <div className="list-sum">{cardcnt}</div>
                </div>
